...
public class AppCentralUB extends javax.swing.JFrame {
    ...
    private void initComponents() {
                ...
                .addGroup(FrmGestioComponentsCentralLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(FrmGestioComponentsCentralLayout.createSequentialGroup()
                        ...
                        .addGroup(FrmGestioComponentsCentralLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(btnIntroduirInsercioBarresControl))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(sldBarresControl, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                        .addGap(62, 62, 62))
                    .addGroup(FrmGestioComponentsCentralLayout.createSequentialGroup()
                        .addComponent(lblBombesRefrigerants2)
                        .addGap(18, 18, 18)
        ...
        labelCentralUB.setText("CENTRAL UB");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(labelCentralUB, javax.swing.GroupLayout.PREFERRED_SIZE, 258, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(62, 62, 62)
    ...
    private void btnGestioComponentsCentralActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGestioComponentsCentralActionPerformed
        try {
            ...
            bomba2 = adaptador.isBombaActivat(1);
            bomba3 = adaptador.isBombaActivat(2);
            bomba4 = adaptador.isBombaActivat(3);
        } catch (CentralUBException ex) {
            JOptionPane.showMessageDialog(null, ex.getMessage());
        }
    ...
    private void btnCancelarModificacionsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarModificacionsActionPerformed
       try{
        ...
        if(adaptador.isBombaActivat(0) != bomba1){
            adaptador.setEstatBomba(bomba1, 0);
        }
        if(adaptador.isBombaActivat(1) != bomba2){
            adaptador.setEstatBomba(bomba2, 1);
        }
        if(adaptador.isBombaActivat(2) != bomba3){
            adaptador.setEstatBomba(bomba3, 2);
        }
        if(adaptador.isBombaActivat(3) != bomba4){
            adaptador.setEstatBomba(bomba4, 3);
        }
       }catch(CentralUBException ex){
            JOptionPane.showMessageDialog(null, ex.getMessage());
    ...
    void llistaForadeServei(){
        ...
        model.clear();
        try {
            if(adaptador.getForadeServei(0)){
                model.addElement("Bomba1");
            }
            if(adaptador.getForadeServei(1)){
                model.addElement("Bomba2");
            }
            if(adaptador.getForadeServei(2)){
                model.addElement("Bomba3");
            }
            if(adaptador.getForadeServei(3)){
                model.addElement("Bomba4");
            }
        } catch (CentralUBException ex) {
            JOptionPane.showMessageDialog(null, ex.getMessage());
        }
